...
class CustomDynamicTheme extends StatefulWidget {
  const CustomDynamicTheme(
  ...
  @override
  CustomDynamicThemeState createState() => CustomDynamicThemeState();

  static CustomDynamicThemeState of(BuildContext context) {
    return context.findAncestorStateOfType<CustomDynamicThemeState>();
   // return context.ancestorStateOfType(const TypeMatcher<DynamicThemeState>());
  }
}

class CustomDynamicThemeState extends State<CustomDynamicTheme> {
  ThemeData _data;
  ...
  @override
  void didUpdateWidget(CustomDynamicTheme oldWidget) {
